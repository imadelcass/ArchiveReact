...
const addNewPiece = async (piece, setDisplay, setAlert) => {
...
const NewPiece = ({ display, setDisplay }) => {
  const { typePieces, dossiers } = useContext(GlobalContext);
      ...
      <div className={style.newPiece}>
        ...
        <div className={style.modelWrapper}>
          ...
          <div className={style.modelBtns}>
            <button onClick={() => addNewPiece(piece, setDisplay, setAlert)}>
              Add
            </button>
          </div>
        </div>
